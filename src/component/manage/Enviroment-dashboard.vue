            ...
            <v-list-item-content>
                ...
                >
                    ...
                    >
                        ...
                        <v-card-actions>
                            <v-btn @click.prevent="goToEditPage(item.name)" color="blue" text>
...
export default {
    ...
    async mounted() {
        console.log('Enviroment-dashboard Page run')
    ...
    methods: {
        /**前往該情境教材的編輯頁面 */
        goToEditPage(name) {
            var obj = { enviro: { name: name } }
            this.$emit('passdata', obj)
            this.$router.push('/edit-enviro')
        },
        /**請求後端並取得情境教材
         * @async
         */
